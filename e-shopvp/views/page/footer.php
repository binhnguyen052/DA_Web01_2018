...
<script src="<?php echo $href_public; ?>/js/slick.min.js"></script>
<script src="<?php echo $href_public; ?>/js/nouislider.min.js"></script>
<script src="<?php echo $href_public; ?>/js/jquery.zoom.min.js"></script>
<script src="<?php echo $href_public; ?>/js/main.js"></script>
